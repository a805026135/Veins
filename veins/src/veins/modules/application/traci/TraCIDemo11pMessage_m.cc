...
int TraCIDemo11pMessage::getSrc() const
{
    return this->src;
}

void TraCIDemo11pMessage::setSrc(int src)
{
    this->src = src;
}

int TraCIDemo11pMessage::getDst() const
{
    return this->dst;
}

void TraCIDemo11pMessage::setDst(int dst)
{
    this->dst = dst;
}
...
bool TraCIDemo11pMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_src: pp->setSrc(string2long(value)); return true;
        case FIELD_dst: pp->setDst(string2long(value)); return true;
